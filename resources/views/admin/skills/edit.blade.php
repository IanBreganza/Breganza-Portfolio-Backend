...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mt-1">Edit: {{ $skill->name }}</h1>
</div>
<form method="POST" action="{{ route('admin.skills.update', $skill) }}" class="bg-white rounded-xl shadow p-6 space-y-5">
    @csrf @method('PATCH')
